...
const Blog = () => {
  return (
    <div className="container mt-5">
      <h6 className="text-center ">SEE LATEST NEWS</h6>
      <h2 className="text-center " id="Blog">My Blog .</h2>
      ...
      <div className="row">
        <div className="card-deck">
          ...
          {/* <div className="card">
            ...
            <div className="card-body">
              <h5 className="card-title">Relorem Plan 2018</h5>
              <p className="card-text text-left">04 April 2018 |</p>
              <p className="mt-5 text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar
              neque.</p>
            </div>
            <div className="card-footer">
              <small className="text-muted font-weight-bold"><a href="#"><FontAwesomeIcon icon={faUser} /> Ranjit Singh</a> </small>
            </div>
          </div>
          <div className="card">
            <img src={img3} className="card-img-top" alt="..." />
            <div className="card-body">
              <h5 className="card-title">Think Inside BOX</h5>
              <p className="card-text text-left">04 April 2018 |</p>
              <p className="mt-5 text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar
              neque.</p>
            </div>
            <div className="card-footer">
              <small className="text-muted font-weight-bold"><a href="#"><FontAwesomeIcon icon={faUser} /> Rahul Dash</a> </small>
            </div>
          </div> */}
        </div>
      </div>
